  			...
  			attendance.datagrid = $('#attendance_datagrid').datagrid({
					...
					columns : [[{
						...
						formatter : function(value, rowData, rowIndex) {
							return '<span style="display:inline-block;vertical-align:middle;"></span><div class="details"><a style="" href="javascript:void(0);" onclick="attendance.goToDeal(' + rowIndex + ');">登记</a></div>';
						}
				}]]
	  			});
	  			...
	  			attendance.goToDeal = function(index) {
					...
					$.messager.confirm('请确认','请确认该出勤单已填写到纸质出勤单？',function(b){
						if(b){
							$.ajax({
