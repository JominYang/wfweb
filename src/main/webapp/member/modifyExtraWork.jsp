	...
	$(function() {
		...
		extrawork.all_datagrid = $('#extrawork_datagrid')
				.datagrid(
						{
							url : sy.bp()
									+ '/extraWork.do?method=get&no=nocheck&extra_add_no='+<%=session.getAttribute("loginNo") %>,
							pagination : true,
							pageSize : 10,
							pageList : [ 10, 20, 30 ],
							fit : true,
...
<body style="background-color: #F5F5F5;font-size: 14px;" class="easyui-layout" fit="true" border="false">
	...
	<div region="center" title="" border="false" style="background-color: #ebf3fb;border-radius:5px;padding-bottom: 30px;">
		<div align=left style="font-size: 18px;color: #eb1446;line-height: 30px;"><b>&nbsp;&nbsp;&gt;&gt;未审核加班表</b></div>
		...
		<form id="extrawork_editForm" name="extrawork_editForm" method="post">
			<table class="tableForm datagrid-toolbar">
				...
				<tr>
					...
					<td><input name="verify_no" id="extraworker2" disabled="disabled" name="member_no"
						type="text" style="width: 210px" />
					</td>
				<tr>
					<td align="right">加班状态</td>
					<td><select name="extra_state" disabled="disabled" style="width: 210px;">
